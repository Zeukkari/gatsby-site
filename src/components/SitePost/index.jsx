...
class SitePost extends React.Component {
  constructor(props) {
    super(props)
    this.state = { iframeEnabled: false }
  ...
  handleClick() {
    this.setState(prevState => ({
      iframeEnabled: !prevState.iframeEnabled,
    }))
  }
  ...
  render() {
    ...
    const enableButton = <button onClick={this.handleClick}>Init Demo</button>

    let __html = isMore ? description : html
    if (iframeEnabled) {
      __html += iframe
    }
